...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    icon: Brain,
    children: [
      { name: 'Sentiment Analysis', href: '/dashboard/ai/sentiment', icon: TrendingUp },
      { name: 'Response Generation', href: '/dashboard/ai/responses', icon: MessageSquare },
      { name: 'Brand Voice', href: '/dashboard/ai/brand-voice', icon: Sparkles },
      { name: 'AI Learning', href: '/dashboard/ai/learning', icon: Brain },
      { name: 'Performance', href: '/dashboard/ai/performance', icon: BarChart3 },
    ]
  },
  {
  ...
  },
  {
    ...
    icon: BarChart3,
    children: [
      { name: 'Realtime', href: '/dashboard/analytics/realtime', icon: TrendingUp },
      { name: 'Sentiment Trends', href: '/dashboard/analytics/sentiment', icon: BarChart3 },
      { name: 'Reputation Score', href: '/dashboard/analytics/reputation', icon: Shield },
      { name: 'Branch Performance', href: '/dashboard/analytics/branches', icon: Building2 },
      { name: 'Team Performance', href: '/dashboard/analytics/team', icon: Users },
    ]
  },
  {
    name: 'Tổ chức',
    ...
    icon: Building2,
    children: [
      { name: 'Chi nhánh', href: '/dashboard/organization/branches', icon: Building2 },
      { name: 'Nhân viên', href: '/dashboard/organization/staff', icon: Users },
      { name: 'Phân quyền', href: '/dashboard/organization/rbac', icon: Shield },
    ]
  },
  {
    name: 'Cài đặt',
    ...
    children: [
      ...
      { name: 'Tổ chức', href: '/dashboard/settings/organization', icon: Building2 },
      { name: 'AI Configuration', href: '/dashboard/settings/ai', icon: Brain },
      { name: 'Thông báo', href: '/dashboard/settings/notifications', icon: Bell },
      { name: 'Thanh toán', href: '/dashboard/settings/billing', icon: CreditCard },
...
export default function Sidebar() {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className={`p-5 border-b border-slate-800 ${collapsed ? 'px-3' : ''}`}>
